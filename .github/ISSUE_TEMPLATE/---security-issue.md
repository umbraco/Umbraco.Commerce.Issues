---
name: 🔐 Security Issue
about: Discovered a Security Issue in Umbraco Workflow?
---

⚠️ PLEASE DON'T DISCLOSE SECURITY-RELATED ISSUES PUBLICLY, SEE BELOW.

If you have found a security issue in Umbraco Workflow, please send the details to
...
The article above also applies to other Umbraco products like CMS, Forms, Deploy and Cloud.
